...
def kalman_step(P_k_k, dt, omega_m_kp1, acc_r, q_hat_k_k, b_hat_k_k, sigma_r, sigma_b, omega_hat_k_k):
    print("EKF")
    """
    ...
    H_kp1 = np.block([geo.cross_prod_mat_3(C @ gravity_vector), np.zeros(shape=(3,3))])
