...
class MQTTDataLogger(QMainWindow):
    def __init__(self):
        ...
        self.sensor_status_labels = {}  # Initialize the dictionary here
        self.actual_data_points = 0  # Also initialize this missing attribute
    ...
    def setup_mqtt(self):
        ...
        # Connect signals
        self.mqtt_worker.message_received.connect(self.handle_sensor_data)
